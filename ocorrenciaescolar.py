...
#   (fonte única — usada pela UI e pelo PDF)
# ─────────────────────────────────────────────
...
def enviar_whatsapp(numero: str, caminho_pdf: str, aluno: str) -> bool:
    try:
        ...
        mensagem = f"Olá Mãe/Pai, estamos enviando esta mensagem para alertar que, seu filho(a) {aluno} recebeu uma ocorrência hoje, em breve iremos te enviar o PDF da ocorrência para que você possa estar ciente, e necessitamos que o quanto antes você venha para a escola assinar a ocorrência."
